...
const LandingPage = () => {
    return (
        ...
        <div className="min-h-screen bg-white overflow-hidden relative flex flex-col">
            {/* Background blobs */}
              <div className="absolute top-0 left-0 w-80 h-80 bg-[#A8F1FF]/50 rounded-full blur-3xl -translate-x-1/4 -translate-y-1/4 z-1000"></div>
            <div className="absolute top-40 left-60 w-40 h-40 bg-[#FFFA8D]/50 rounded-full blur-xl z-1000"></div>
            <div className="absolute top-60 right-20 w-60 h-60 bg-[#A8F1FF]/40 rounded-full blur-2xl z-1000"></div>
            <div className="absolute bottom-40 right-0 w-96 h-96 bg-[#FFFA8D]/30 rounded-full blur-3xl z-1000"></div>
            <div className="absolute bottom-0 left-0 w-full h-96 bg-gradient-to-t from-[#FFFA8D]/20 to-transparent z-1000"></div>
