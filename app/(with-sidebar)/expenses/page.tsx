...
export default function ExpenseTracker() {
    ...
    console.log(FormData, "formData in useEffect");
     ...
     useEffect(() => {
    console.log(JSON.stringify(FormData), "formData in useEffect helloo guys");
    },[])
...
const handleSubmit = async (e: any) => {
  ...
  try {
    ...
    // Create data object without modifying original state
    const dataToSend = {
      ...formData,
      user_id,
    };
                  ...
                  {recentExpenses.map((expense) => (
                    <div key={expense.id} className="border-l-4 border-gray-200 pl-4 py-2">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <span className="text-xs text-gray-500">{expense.sub_category}</span>
                      </div>
